  ...
  return (
    <div className="bistroBoss-Details hero min-h-[572px] relative">
      ...
      <div className="flex justify-center items-center h-full px-4 md:px-6 lg:px-0">
        <div className="w-full  bg-white/95 backdrop-blur-md px-6 md:px-10 lg:px-18 py-8 md:py-12 rounded-xl shadow-xl border border-gray-200 text-center">
          {/* Title */}
          ...
          <p className="mt-1 text-sm md:text-base lg:text-md text-gray-700 leading-relaxed">
